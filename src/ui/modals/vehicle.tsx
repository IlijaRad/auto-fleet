...
import type { Vehicle, VehicleValidate } from "@/lib/types";
...
export default function VehicleModal({
  ...
  onClose: () => void;
  onSave: (vehicleData: VehicleValidate) => void;
}) {
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            <Dialog.Close asChild>
              <button
                className="text-gray-500 cursor-pointer hover:text-gray-700 p-1 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                aria-label="Close"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex space-x-3 pt-4">
              ...
              <button
                type="submit"
                className="flex-1 px-4 py-2 bg-indigo-600 text-white rounded-lg cursor-pointer hover:bg-indigo-700 transition-colors"
              >
